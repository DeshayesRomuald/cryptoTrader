...
// const ohlc = clone(ethOhlc);
// const ohlc = clone(ltcOhlc);
const ohlc = clone(ltcOhlc6);
// const ohlc = clone(ltcOhlc15m);
// const ohlc = clone(eth5m);
// const ohlc = clone(xmr7);
// const ohlc = clone(xmr5m);
...
function estimateTrailingStopPercent(slidingWindow) {
  ...
  return stdDevCandleSizePercent * 4;
}
